...
function Awake() 
     ...
     local data = GetInstanceData("Knight", my_id)
end
...
function UpdateKnightHealthbar(id)
     local data = GetInstanceData("Knight", id)
...
function DamageKnight(id, amount)
     local data = GetInstanceData("Knight", id)

     data.currentHealth = data.currentHealth - amount
     UpdateKnightHealthbar(id)
